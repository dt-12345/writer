...
void drawTool2DSuper(agl::lyr::Layer* layer, const agl::lyr::RenderInfo& info) {
    ...
    gDrawMgr.begin();
    gDrawMgr.drawLine(sead::Vector3f(0.f, 0.f, 0.f), sead::Vector3f(2000.f, 0.f, 0.f), sead::Color4f(1.f, 1.f, 1.f, 1.f), sead::Color4f(1.f, 1.f, 1.f, 1.f));
    gDrawMgr.drawSphere4x8(sead::Vector3f(10.f, 10.f, 10.f), 1000.f, sead::Color4f(1.f, 1.f, 1.f, 1.f), sead::Color4f(1.f, 1.f, 1.f, 1.f));
    gDrawMgr.drawAxis(sead::Vector3f(0.f, 0.f, 0.f), 1000.f);
    gDrawMgr.end();
}
