...
public:
    ...
    virtual void bindImpl_(DrawContext* draw_context) const;
...
public:
    ...
    static FrameBufferNvn* create(Heap*, Vector2f*, u32 width, u32 height);

    void bindClear_(DrawContext* draw_context) const override;
    void unbindImpl_(DrawContext* draw_context) const override;
